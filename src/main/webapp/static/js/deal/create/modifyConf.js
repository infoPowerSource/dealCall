...
$(function(){
    ...
    var tmpdate1 = confStartTime.substring(0,10);
    var tmpdate2 = tmpdate1.replace(/-|\./g,"/");
    var date_New = new Date(tmpdate2);
    $("#beginTime").val(confStartYear[0]+"/"+confStartYear[1]+"/"+confStartYear[2]);
    $(".weekday").text("(" + days[date_New.getDay()] + ")");
