...
String.prototype.formatString = function (/*String*/srcString, /*Array*/params) { 
    ...
    if (params) { 
        ...
        if(paramLen < 10){ 
            ...
            expStr = "[1-9]"; 
            for(var i = 10; i <= paramLen; i++){ 
                expStr += "|" + i; 
            } 
        } 
        var reg = new RegExp("{(" + expStr + ")}", "ig"); 
...
var DatePicker = function (element, YMDInputId, onValueChange) {
    this.$parent = $(element);
...
DatePicker.prototype = {
    ...
    updateDisDate: function (y, m) {
        this.$disDate.html(String.prototype.formatString("{1}年{2}月", [y, m < 10 ? "0" + m : m])).attr('date', y + '-' + m);
    },
    ...
    getDisDateValue: function () {
        var date = this.$disDate.attr('date');
