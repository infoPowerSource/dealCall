...
<body>
<div id="creteConf">
	<header id="header" class="mui-bar mui-bar-nav s-bgc-4882bf" v-show="!form.showNotify && !form.showJoin">
	...
	<div class="mui-content" v-show="!form.showNotify && !form.showJoin">
	<form id="addTask">
						...
						<ul class="mui-input-group mui-input-group-2 f-p010">
							...
							<li class="mui-input-row-2 m-c2 f-cb f-bb-E7E7E7">
								...
								<div class="mui-input-row-2 m-c2 f-p015 f-cb">
									...
									<div class="m-c2-bd">
										<div class="f-inp-qh1">
											<input type="tel" placeholder="区号" id="area" name="zj" class="f-inp " v-model.trim="item.dat.quh" data-id="quh" @change="inpchange($event.target,item.dat.quh,form.anpai,key)" maxlength="4">
										</div>
										<input type="tel" placeholder="电话号码" id="phoneNum" name="zj" class="f-tel" v-model.trim="item.dat.pho" data-id="pho" @change="inpchange($event.target,item.dat.pho,form.anpai,key)" maxlength="20">
									</div>
								</div>
							</li>
							<li class="mui-input-row-2 m-c2 f-cb f-bb-E7E7E7">
						...
						<ul class="mui-input-group mui-input-group-2 f-p010">
							...
							<li class="mui-input-row-2 m-c2 f-cb f-bb-E7E7E7">
								...
								<div class="mui-input-row-2 m-c2 f-p015 f-cb">
									...
									<div class="m-c2-bd">
										<div class="f-inp-qh1">
											<input type="tel" placeholder="区号" id="area" name="kh" class="f-inp" v-model.trim="item.dat.quh" data-id="quh" @change="inpchange($event.target,item.dat.quh,form.anpai,key)" maxlength="4">
										</div>
										<input type="tel" placeholder="电话号码" id="phoneNum" name="kh" class="f-tel" v-model.trim="item.dat.pho" data-id="pho" @change="inpchange($event.target,item.dat.pho,form.anpai,key)" maxlength="20">
									</div>	
								</div>
							</li>
							<li class="mui-input-row-2 m-c2 f-cb f-bb-E7E7E7">
				...
				<div class="m-tabs m-tabs-1">
					...
					<div class="m-tabs-bd">
						<ul class="mui-input-group mui-input-group-2 f-p010">
							...
							<li class="mui-input-row-2 m-c2 f-cb f-bb-E7E7E7" @click="form.showNotify = !form.showNotify">
								<label class="m-c2-hd m-c2-hd-1">会议通知</label>
								<div class="m-c2-bd f-tar" id="notify">
									{{form.anpai.cfg.notifyemail == 1 ? "邮件" : "  "}}
									{{form.anpai.cfg.notifysms == 1 ? "短信" : ""}}
									>
								</div>
							</li>
							<li class="mui-input-row-2 m-c2 f-cb f-bb-E7E7E7r" @click="form.showJoin = !form.showJoin">
								<label class="m-c2-hd m-c2-hd-1">入会限制</label>
								<div class="m-c2-bd f-tar" id="join">
									{{form.anpai.cfg.join == 0 ? "不限制主动入会电话" : "仅允许邀请的电话主动入会"}}
									>
								</div>
							</li>
				  		</ul>
	...
	<div id="showNotify" v-show="form.showNotify">
		<header class="mui-bar mui-bar-nav s-bgc-4882bf">
			<h1 class="mui-title">会议通知</h1>
			<button class="mui-btn mui-btn-blue mui-btn-link mui-btn-nav mui-pull-left" style="font-size: 15px" @click="form.showNotify = !form.showNotify"><span class="mui-icon mui-icon-left-nav"></span>返回</button>
		</header>
		<div class="mui-content">
			<ul class="mui-input-group mui-input-group-2 f-mt15 f-p010">
				<li class="mui-input-row-2 m-c2 f-cb f-bb-E7E7E7" @click="form.anpai.cfg.notifyemail == 0 ? form.anpai.cfg.notifyemail=1 : form.anpai.cfg.notifysms==0 ? layer.msg('请至少选择一项通知！') : form.anpai.cfg.notifyemail=0">
					邮件通知
					<i style="float: right;" v-show="form.anpai.cfg.notifyemail == 1">&#10004</i>
				</li>
				<li class="mui-input-row-2 m-c2 f-cb f-bb-E7E7E7" @click="form.anpai.cfg.notifysms == 0 ? form.anpai.cfg.notifysms=1 : form.anpai.cfg.notifyemail==0 ? layer.msg('请至少选择一项通知！') : form.anpai.cfg.notifysms=0">
					短信通知
					<i style="float: right;" v-show="form.anpai.cfg.notifysms == 1">&#10004</i>
				</li>
			</ul>
		</div>
	</div>
	<div id="showJoin" v-show="form.showJoin">
		<header class="mui-bar mui-bar-nav s-bgc-4882bf">
			<h1 class="mui-title">入会限制</h1>
			<button class="mui-btn mui-btn-blue mui-btn-link mui-btn-nav mui-pull-left" style="font-size: 15px" @click="form.showJoin = !form.showJoin"><span class="mui-icon mui-icon-left-nav"></span>返回</button>
		</header>
		<div class="mui-content">
			<ul class="mui-input-group mui-input-group-2 f-mt15 f-p010">
				<li class="mui-input-row-2 m-c2 f-cb f-bb-E7E7E7" @click="form.anpai.cfg.join=1">
					仅允许邀请的电话主动入会
					<i style="float: right;" v-show="form.anpai.cfg.join == 1">&#10004</i>
				</li>
				<li class="mui-input-row-2 m-c2 f-cb f-bb-E7E7E7" @click="form.anpai.cfg.join=0">
					不限制主动入会电话
					<i style="float: right;" v-show="form.anpai.cfg.join == 0">&#10004</i>
				</li>
			</ul>
		</div>
	</div>
