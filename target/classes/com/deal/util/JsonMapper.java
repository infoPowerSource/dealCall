...
public class JsonMapper {
    ...
    public <T> List<T> getList(String jsonVal, Class<?> clazz) throws JsonParseException, JsonMappingException, IOException {
        TypeFactory t = TypeFactory.defaultInstance();
        // 指定容器结构和类型（这里是ArrayList和clazz）
        List<T> list = mapper.readValue(jsonVal, t.constructCollectionType(List.class, clazz));
        // 如果T确定的情况下可以使用下面的方法：
