...
<header id="header" class="mui-bar mui-bar-nav s-bgc-4882bf">
    ...
    <a class="mui-action-back mui-btn mui-btn-blue mui-btn-link mui-btn-nav mui-pull-left"
       href="${CTX}/login" style="font-size: 15px"><span class="mui-icon mui-icon-left-nav"></span>返回</a>
</header>
<div id="app" class="mui-content" v-cloak>
    ...
    <div class="mui-input-row-2 m-btn-2">
        <button id="login-btn" type="button" class="mui-btn mui-btn-primary mui-btn-block f-btn f-btn-middle s-bgc-4882bf" @click="submit()" :disabled="user.password=='' || user.confirmPwd==''">提交
        </button>
    </div>
</div>
