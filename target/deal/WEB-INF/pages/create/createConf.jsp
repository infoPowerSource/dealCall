                    ...
                    <div class="input-bt-line last">
                        ...
                        <div class="advanced">
                            ...
                            <span class="advanced-item">会议通知</span>
                                <input type="checkbox" name="notifyemail" id="notifyemail" value="1" checked onclick="notify(this)"/>
                            <label for="notifyemail" style="margin-right: 50px;">邮件通知</label>
                                <input type="checkbox" name="notifysms" id="notifysms" value="1" checked onclick="notify(this)"/>
                            <label for="notifysms">短信通知</label>
                            <span class="message pwd0_msg"></span>
                            </div>
                            <div>
                            <span class="advanced-item">入会限制</span>
                            <input type="radio" name="join" id="join1" value="1"/>
                            <label for="join1" style="margin-right: 50px;">仅允许邀请的电话主动入会</label>
                            <input type="radio" name="join" id="join" value="0" checked/>
