...
public class BossConfereceMonitorController{
	 ...
	 * 查看会议监控
	 */
	@RequestMapping(value = "boss/getConfDetail/{billingcode}/{empid}", method = RequestMethod.GET)
	@ResponseBody
	public ModelAndView confMon(@PathVariable String billingcode,@PathVariable String empid, HttpServletRequest request){
		if(billingcode == null) {
